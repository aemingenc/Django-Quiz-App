# Generated by Django 4.0.2 on 2022-03-11 07:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('Mobile', 'Mobile'), ('Frontend', 'Frontend'), ('Backend', 'Backend')], default='Mobile', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Quiz',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.CharField(choices=[('Low', 'Low'), ('Medium', 'Medium'), ('Hard', 'Hard')], default='Low', max_length=10)),
